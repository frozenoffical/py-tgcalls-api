...
DOWNLOAD_APIS = {
    'default': os.environ.get('DOWNLOAD_API_URL', 'http://68.183.106.44:5001/download?url='),
    'secondary': os.environ.get('SECONDARY_DOWNLOAD_API_URL', 'http://68.183.106.44:5000/download?url='),
}
